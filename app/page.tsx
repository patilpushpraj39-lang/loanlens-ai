...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setToken(id);
    fetch("/api/status").then(r => r.json()).then(d => { const status = d as { claude?: boolean; sheets?: boolean }; setConnection({ claude: !!status.claude, sheets: !!status.sheets }); }).catch(() => {});
  }, []);
